...
#define ESCAPE (4 * MAX_INSN_KIND)
#define RETURN_ABRUPT return ESCAPE;
...
static unsigned get_jmp_target(bjvm_bytecode_insn *inst, bjvm_reduced_tos_kind t) {
  int result = inst->kind * 4 + t;
  return result;
}

#define JMP_INT(tos) _Generic(*tos_, \
  int64_t: ({ *tos_ = (int64_t)(tos); return get_jmp_target(insn, TOS_INT); }), \
  default: ({ *arg_1 = (int64_t)(tos); return get_jmp_target(insn, TOS_INT); }) \
);
#define JMP_FLOAT(tos) _Generic(*tos_, \
float: ({ *tos_ = (float)(tos); return get_jmp_target(insn, TOS_FLOAT); }),\
default: ({ *arg_2 = (float)(tos); return get_jmp_target(insn, TOS_FLOAT); })\
);
#define JMP_DOUBLE(tos) _Generic(*tos_, \
double: ({ *tos_ = (double)(tos); return get_jmp_target(insn, TOS_DOUBLE); }), \
default: ({ *arg_3 = (double)(tos); return get_jmp_target(insn, TOS_DOUBLE); })\
);
#define JMP_VOID return get_jmp_target(insn, TOS_VOID);

#define NEXT_INT(tos) { typeof(tos) evaled = tos; insn += 1; pc += 1; _Generic(*tos_, \
int64_t: ({ *tos_ = (int64_t)(evaled); return get_jmp_target(insn, TOS_INT); }), \
default: ({ *arg_1 = (int64_t)(evaled); return get_jmp_target(insn, TOS_INT); }) \
); }
#define NEXT_FLOAT(tos) { typeof(tos) evaled = tos; insn += 1; pc += 1; _Generic(*tos_, \
float: ({ *tos_ = (float)(evaled); return get_jmp_target(insn, TOS_FLOAT); }), \
default: ({ *arg_2 = (float)(evaled); return get_jmp_target(insn, TOS_FLOAT); }) \
); }
#define NEXT_DOUBLE(tos) { typeof(tos) evaled = tos; insn += 1; pc += 1; _Generic(*tos_, \
double: ({ *tos_ = (double)(evaled); return get_jmp_target(insn, TOS_DOUBLE); }), \
default: ({ *arg_3 = (double)(evaled); return get_jmp_target(insn, TOS_DOUBLE); }) \
); }
#define NEXT_VOID { insn += 1; pc += 1; return get_jmp_target(insn, TOS_VOID); }
...
// Java saturates the conversion
__attribute__((noinline, used)) static int64_t double_to_long(double x) {
...
__attribute__((noinline, used)) static int64_t getstatic_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t putstatic_impl_void(ARGS_VOID) {
  DEBUG_CHECK
  resolve_getstatic_putstatic_t ctx = {0};
  ctx.args.thread = thread;
  ctx.args.inst = insn;
...
__attribute__((noinline, used)) static int64_t getstatic_L_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t getstatic_F_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getstatic_D_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getstatic_J_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getstatic_I_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getstatic_S_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getstatic_C_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getstatic_B_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getstatic_Z_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t putstatic_B_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putstatic_C_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putstatic_S_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putstatic_I_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putstatic_J_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putstatic_F_impl_float(ARGS_FLOAT) {
...
__attribute__((noinline, used)) static int64_t putstatic_D_impl_double(ARGS_DOUBLE) {
...
__attribute__((noinline, used)) static int64_t putstatic_L_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putstatic_Z_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t getfield_B_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_C_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_S_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_I_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_J_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_F_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_D_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_L_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t getfield_Z_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_B_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_C_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_S_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_I_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_J_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_L_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_Z_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t putfield_F_impl_float(ARGS_FLOAT) {
...
__attribute__((noinline, used)) static int64_t putfield_D_impl_double(ARGS_DOUBLE) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t which##_impl_int(ARGS_INT) {                                                                          \
DEBUG_CHECK                                                                                                        \
...
INTEGER_UN_OP(i2f, (float)(int)a, NEXT_FLOAT)
INTEGER_UN_OP(i2d, (double)(int)a, NEXT_DOUBLE)
...
__attribute__((noinline, used)) static int64_t idiv_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t ldiv_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t lcmp_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t irem_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t lrem_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t arraylength_impl_int(ARGS_INT) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t aastore_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t return_impl_void(ARGS_VOID) {
  DEBUG_CHECK
  SPILL_VOID
  return 0;
}
...
__attribute__((noinline, used)) static int64_t areturn_impl_int(ARGS_INT) {
  DEBUG_CHECK
  SPILL(tos);
  return (int64_t)(uintptr_t)tos;
}

__attribute__((noinline, used)) static int64_t ireturn_impl_int(ARGS_INT) {
  DEBUG_CHECK
  SPILL(tos);
  return (int)tos;
}

__attribute__((noinline, used)) static int64_t lreturn_impl_int(ARGS_INT) {
  DEBUG_CHECK
  SPILL(tos);
  return tos;
}

__attribute__((noinline, used)) static int64_t freturn_impl_float(ARGS_FLOAT) {
  DEBUG_CHECK
  SPILL(tos);
  int64_t a = 0;
...
__attribute__((noinline, used)) static int64_t dreturn_impl_double(ARGS_DOUBLE) {
  DEBUG_CHECK
  SPILL(tos);
  int64_t a = 0;
...
__attribute__((noinline, used)) static int64_t goto_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t goto_impl_double(ARGS_DOUBLE) {
...
__attribute__((noinline, used)) static int64_t goto_impl_float(ARGS_FLOAT) {
...
__attribute__((noinline, used)) static int64_t goto_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t tableswitch_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t lookupswitch_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t if_acmpeq_impl_int(ARGS_INT) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t if_acmpne_impl_int(ARGS_INT) {
  DEBUG_CHECK
  uintptr_t a = (sp - 2)->l, b = tos;
  int old_pc = pc;
  pc = a != b ? (insn->index - 1) : pc;
...
__attribute__((noinline, used)) static int64_t monitorenter_impl_int(ARGS_INT) {
  DEBUG_CHECK
  if (unlikely(!tos)) {
    SPILL(tos);
    bjvm_null_pointer_exception(thread);
...
__attribute__((noinline, used)) static int64_t monitorexit_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t new_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t new_resolved_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t newarray_impl_int(ARGS_INT) {
  DEBUG_CHECK
  int count = tos;
  SPILL(tos)
  if (unlikely(count < 0)) {
...
__attribute__((noinline, used)) static int64_t anewarray_impl_int(ARGS_INT) {
...
// <length> -> <object>
__attribute__((noinline, used)) static int64_t anewarray_resolved_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t multianewarray_impl_int(ARGS_INT) {
  DEBUG_CHECK
  SPILL(tos)
...
__attribute__((noinline, used)) static int64_t invokestatic_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t invokestatic_resolved_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t invokevirtual_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t invokespecial_impl_void(ARGS_VOID) {
  DEBUG_CHECK
  bjvm_cp_method_info *method_info = &insn->cp->methodref;
  int argc = insn->args = method_info->descriptor->args_count + 1;
  bjvm_obj_header *target = (sp - argc)->obj;
...
__attribute__((noinline, used)) static int64_t invokeinterface_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) void make_invokevtable_polymorphic_(bjvm_bytecode_insn *inst) {
...
__attribute__((noinline, used)) void make_invokeitable_polymorphic_(bjvm_bytecode_insn *inst) {
...
FORWARD_TO_NULLARY(invokeitable_vtable_monomorphic)
 ...
 static int64_t invokesigpoly_impl_void(ARGS_VOID) {
  DEBUG_CHECK
  bjvm_obj_header *target = (sp - insn->args)->obj;
  bool returns = insn->cp->methodref.descriptor->return_type.base_kind != BJVM_TYPE_KIND_VOID;
  SPILL_VOID
...
__attribute__((noinline, used)) static int64_t invokeitable_polymorphic_impl_void(ARGS_VOID) {
  DEBUG_CHECK
  bjvm_obj_header *target = (sp - insn->args)->obj;
  bool returns = insn->cp->methodref.descriptor->return_type.base_kind != BJVM_TYPE_KIND_VOID;
  SPILL_VOID
...
__attribute__((noinline, used)) static int64_t invokevtable_polymorphic_impl_void(ARGS_VOID) {
  DEBUG_CHECK
  bjvm_obj_header *target = (sp - insn->args)->obj;
  bool returns = insn->cp->methodref.descriptor->return_type.base_kind != BJVM_TYPE_KIND_VOID;
  SPILL_VOID
...
__attribute__((noinline, used)) static int64_t invokedynamic_impl_void(ARGS_VOID) {
  DEBUG_CHECK
  SPILL_VOID
...
__attribute__((noinline, used)) static int64_t invokecallsite_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t istore_impl_int(ARGS_INT) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t fstore_impl_float(ARGS_FLOAT) {
...
__attribute__((noinline, used)) static int64_t dstore_impl_double(ARGS_DOUBLE) {
...
__attribute__((noinline, used)) static int64_t lstore_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t iinc_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t iinc_impl_double(ARGS_DOUBLE) {
...
__attribute__((noinline, used)) static int64_t iinc_impl_float(ARGS_FLOAT) {
...
__attribute__((noinline, used)) static int64_t iinc_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t aconst_null_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t ldc_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t ldc2_w_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t iconst_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t fconst_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t dconst_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t lconst_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t pop_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t pop2_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t swap_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t nop_impl_void(ARGS_VOID) {

  DEBUG_CHECK
  NEXT_VOID
}

__attribute__((noinline, used)) static int64_t nop_impl_double(ARGS_DOUBLE) {

  DEBUG_CHECK
  NEXT_DOUBLE(tos)
}

__attribute__((noinline, used)) static int64_t nop_impl_float(ARGS_FLOAT) {

  DEBUG_CHECK
  NEXT_FLOAT(tos)
}

__attribute__((noinline, used)) static int64_t nop_impl_int(ARGS_INT) {

  DEBUG_CHECK
  NEXT_INT(tos)
}

__attribute__((noinline, used)) static int64_t dup_impl_int(ARGS_INT) {
  DEBUG_CHECK(sp++ - 1)->l = tos;
  NEXT_INT(tos)
}

__attribute__((noinline, used)) static int64_t dup_impl_float(ARGS_FLOAT) {

  DEBUG_CHECK(sp++ - 1)->f = tos;
  NEXT_FLOAT(tos)
}

__attribute__((noinline, used)) static int64_t dup_impl_double(ARGS_DOUBLE) {
...
__attribute__((noinline, used)) static int64_t dup2_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t dup_x1_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t dup_x2_impl_void(ARGS_VOID) {
  DEBUG_CHECK
...
__attribute__((noinline, used)) static int64_t dup2_x1_impl_void(ARGS_VOID) {
...
__attribute__((noinline, used)) static int64_t dup2_x2_impl_void(ARGS_VOID) {
...
FORWARD_TO_NULLARY(dup2_x2)
 ...
 static int64_t entry(ARGS_VOID) { STACK_POLYMORPHIC_JMP(*(sp - 1)) }
 static int64_t jmp_void(ARGS_VOID) { JMP_VOID }

/** Misc. */
__attribute__((noinline, used)) static int64_t athrow_impl_int(ARGS_INT) {
  DEBUG_CHECK
  SPILL(tos)
...
__attribute__((noinline, used)) static int64_t checkcast_impl_int(ARGS_INT) {
  DEBUG_CHECK
  bjvm_cp_class_info *info = &insn->cp->class_info;
  SPILL(tos)
  int error = bjvm_resolve_class(thread, info);
...
__attribute__((noinline, used)) static int64_t checkcast_resolved_impl_int(ARGS_INT) {
...
__attribute__((noinline, used)) static int64_t instanceof_impl_int(ARGS_INT) {
  DEBUG_CHECK
  bjvm_cp_class_info *info = &insn->cp->class_info;
  SPILL(tos)
  int error = bjvm_resolve_class(thread, info);
...
__attribute__((noinline, used)) static int64_t instanceof_resolved_impl_int(ARGS_INT) {
  DEBUG_CHECK
  bjvm_obj_header *obj = (bjvm_obj_header *)tos;
...
__attribute__((noinline, used)) static int64_t dsqrt_impl_double(ARGS_DOUBLE) {
  DEBUG_CHECK
...
#define always_false buf

EMSCRIPTEN_KEEPALIVE
void break_the_program() {
  always_false = true;
}

#if !DO_TAILS
__attribute__((noinline, used))
int64_t interpreter_hell(bjvm_thread *thread, bjvm_stack_frame *frame_) {
  int64_t int_tos = 0;
  float float_tos = 0;
  double double_tos = 0;
  int pc_ = frame_->plain.program_counter;
  bjvm_stack_value *sp_ = &frame_->plain.stack[stack_depth(frame_)];
  bjvm_bytecode_insn *insns = frame_->method->code->code;
  bjvm_bytecode_insn *current = insns + pc_;

  switch (insns[pc_].tos_before) {
  case TOS_INT:
    int_tos = (sp_ - 1)->l;
    break;
  case TOS_FLOAT:
  ...
  unsigned jump_to = current->kind * 4 + insns[pc_].tos_before;
  bjvm_stack_value result;
  while (true) {
...
#else
    result.l = interpreter_hell(thread, frame_);
    // Discourage inlining of interpreter_hell because wasm-opt
    if (always_false) {
      interpreter_hell(thread, frame_);
      interpreter_hell(thread, frame_);
      interpreter_hell(thread, frame_);
      interpreter_hell(thread, frame_);
    }
